...
class SendPayrollRecordPaidPush implements ShouldQueue
{
    ...
    public function handle(PayrollRecordPaid $event): void
    {
        $record = $event->record;
        ...
        $this->fcmService->sendToUser(
            $employee->user,
            '¡Tu pago está listo!',
            "Recibiste RD$ {$gross} por el período {$periodName}. ¡Gracias por tu trabajo!",
            [
                'type' => 'payroll_paid',
    ...
    public function failed(PayrollRecordPaid $event, \Throwable $e): void
    {
        Log::error('SendPayrollRecordPaidPush failed', [
